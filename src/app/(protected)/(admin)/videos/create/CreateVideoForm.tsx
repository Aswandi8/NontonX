...
import { createVideo, type CreateVideoInput } from "../actions";
...
export default function CreateVideoForm({ categories }: CreateVideoFormProps) {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!result.success) {
        toast.error(result.error ?? "Unable to create video.");
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <section className="space-y-6 border-t border-border pt-8">
            <div>
              ...
              <Text className="mt-1 text-sm text-muted-foreground">
                Add the thumbnail and video source.
              </Text>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Text className="text-xs text-muted-foreground">
                Enter the thumbnail URL. CDN upload will be integrated later.
              </Text>
            </div>
      ...
      <div className="min-w-0 lg:sticky lg:top-24 lg:self-start">
        <div className="rounded-xl border border-border bg-card p-5">
          <div className="mb-5">
            ...
            <Text className="mt-1 text-sm text-muted-foreground">
              Preview how this video will appear before creating it.
            </Text>
          </div>
